...
namespace DotNetMidtermA.Controllers
{
    ...
    public class FlightsController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.ProvinceId = new SelectList(db.Provinces.OrderBy(p => p.Name), "ProvinceId", "Name");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "FlightId,FlightTypeId,ProvinceId,ExtraBag,FirstName,LastName")] Flight flight)
        {
            ...
            ViewBag.ProvinceId = new SelectList(db.Provinces.OrderBy(p => p.Name), "ProvinceId", "Name", flight.ProvinceId);
            return View(flight);
        }
